            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-8">
                        ...
                        <div class="col-lg-12 col-md-12 mb-5" v-for="blog in searchResult">
                            <div class="blog-item">
...
export default {
  ...
  created() {
    const searchResultString = this.$route.params.searchResult;
    this.searchResult = JSON.parse(decodeURIComponent(searchResultString));
  },
